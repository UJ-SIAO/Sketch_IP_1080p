...
synth_design -top imageProcessTop -part xc7z020clg484-1 -directive AreaOptimized_high -control_set_opt_threshold 1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef imageProcessTop.dcp
create_report "synth_3_synth_report_utilization_0" "report_utilization -file imageProcessTop_utilization_synth.rpt -pb imageProcessTop_utilization_synth.pb"
