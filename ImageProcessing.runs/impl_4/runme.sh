...
HD_PWD='D:/GitCode/Sketch_IP_1080p/ImageProcessing.runs/impl_4'
cd "$HD_PWD"
...
EAStep vivado -log imageProcessTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source imageProcessTop.tcl -notrace
